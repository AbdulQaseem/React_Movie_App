...
function TrandingTvShow() {

    const [TrandingTvShow, setTrandingTvShow] = useState([]);


    useEffect(()=>{
      fetch("https://api.themoviedb.org/3/discover/tv?api_key=105b3449e54997efc78dbad890bf50dc&sort_by=popularity.desc&without_genres=16&page=1")
      .then(res => res.json())
