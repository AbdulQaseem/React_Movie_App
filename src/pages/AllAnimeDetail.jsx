                ...
                {Anime && (
                    <>
                        ...
                        <div className=" w-full flex flex-col md:flex-row items-center p-6 gap-6 absolute top-[44.5%]">
                            ...
                            />
                            <div className="mt-3">
                                <h1 className="text-4xl font-bold font-serif mb-2 mt-6 blur-md invert drop-shadow-xl md:filter-none shadow-black">{Anime.name}</h1>
                               <p>
