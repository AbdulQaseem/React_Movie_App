                ...
                {movie && (
                    <>
                        ...
                        <div className=" w-full flex flex-col md:flex-row items-center p-6 gap-6 absolute top-[44.5%]">
                            ...
                            />
                            <div className="mt-3">
                                <h1 className="text-4xl font-bold font-serif mb-4 blur-md invert drop-shadow-xl md:filter-none shadow-black">{movie.title}</h1>
                               <p>
...
export default PopularMoviesDetail;
