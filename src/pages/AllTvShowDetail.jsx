...
function AllTvShowDetail() {
  const { TvShowId } = useParams(); // Get movieId from the URL
                ...
                {TvShow && (
                    <>
                        ...
                        <div className=" w-full flex flex-col md:flex-row items-center p-6 gap-6 absolute top-[44.5%]">
                            ...
                            />
                            <div className="mt-3">
                                <h1 className="text-4xl font-bold font-serif mb-3 mt-6 blur-md invert drop-shadow-xl md:filter-none shadow-black">{TvShow.original_name}</h1>
                               <p>
...
export default AllTvShowDetail